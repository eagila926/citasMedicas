...
<div class="wrapper">    
    ...
    <div class="row">
        <div class="col-5">
            ...
            <h5 style="margin-left: 30px">FASE II</h5>
            <div class="first" id="first">
                <div id="contenido-sexto">
                    <div class="input-group mb-3">
                        <textarea type="text" class="form-control" id="recomendacion-personalizada" placeholder="Escribe el contenido de esta sección"></textarea>
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <a href="#" id="btn-continuar-item7" class="btn btn-success">Continuar →</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-7">
            ...
            <div class="segundafase">
                <h4 id="titulo-segundafase" style="margin-top:20px;"></h4>

                <div id="lista-segundafase"></div>
            </div>
    ...
    <script>
        ...
        $(document).on("click", "#agregar-recomendacion", function () {
            ...
            const resumen = $("#lista-segundafase");
        ...
        $(document).on("click", "#btn-continuar-item7", function (e) {
            e.preventDefault();
            const segundoItem = $("#plan-lista li:nth-child(7)").text().trim();
            ...
            if (archivo) {
                ...
                const contenidoFaseii = document.querySelector(".segundafase").innerHTML;
                localStorage.setItem("html_segundafase", contenidoFaseii);

                window.location.href = `${archivo}?cedula=${cedula}`;
            }
            else {
                alert("No se encontró una ruta para el ítem 7 del plan.");
            }
        });
        ...
        if (localStorage.getItem("html_plan")) {
            ...
            planItems.each(function(index) {
                ...
                if (texto.toUpperCase().includes("FASE II SOPORTE")) {
                    const numero = index + 1;
                    $("#titulo-segundafase").text(`${numero}. ${texto}`);
                }
            });
        }
