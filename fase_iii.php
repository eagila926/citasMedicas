...
<div class="wrapper">    
    ...
    <div class="row">
        <div class="col-5"> 
            ...
            <div class="first" id="first">
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <a href="#" id="btn-continuar-item8" class="btn btn-success">Continuar →</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-7">
            ...
            <div class="tercerafase">
                <h4 id="titulo-tercerafase" style="margin-top:20px;"></h4>

                <div id="lista-tercerafase"></div>
            </div>
    ...
    <script>
        ...
        $(document).on("click", "#agregar-recomendacion", function () {
            ...
            const resumen = $("#lista-tercerafase");
        ...
        $(document).on("click", "#btn-continuar-item8", function (e) {
            e.preventDefault();
            const segundoItem = $("#plan-lista li:nth-child(8)").text().trim();
            ...
            if (archivo) {
                ...
                const contenidoFaseiii = document.querySelector(".tercerafase").innerHTML;
                localStorage.setItem("html_tercerafase", contenidoFaseiii);
        ...
        if (localStorage.getItem("html_plan")) {
            ...
            planItems.each(function(index) {
                ...
                if (texto.toUpperCase().includes("FASE III ")) {
                    const numero = index + 1;
                    $("#titulo-tercerafase").text(`${numero}. ${texto}`);
                }
            });
        }
