...
<div class="wrapper">    
    ...
    <div class="row">
        <div class="col-5"> 
            ...
            <h5 style="margin-left: 30px">Terapia de Hipnosis</h5>
        ...
        <div class="col-7">
            ...
            <div class="hipnosis">
                <h4 id="titulo-hipnosis" style="margin-top:20px;"></h4>
                <p>
                    (Anexo folleto donde explico en qué consiste la terapia y amplia información 
                    <a href="uploads/NW_INFORMACION_TERAPIA_DE_REGRESION_dra_Clara_Maria.pdf" target="_blank">clic aquí</a>)
                </p>
                <div id="lista-hipnosis"></div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (!isNaN(pasos) && htmlPlan) {
                ...
                if (liItems[pasos]) {
                    ...
                    $("#titulo-hipnosis").text(`${numeroPaso}. ${contenidoPaso}`).show();
                } else {
                    $("#titulo-hipnosis").hide();
                }
            }
        });
        ...
        $(document).on("click", "#btn-continuar-item10", function (e) {
            e.preventDefault();
            continuarFlujo("hipnosis", "html_hipnosis");
        });
